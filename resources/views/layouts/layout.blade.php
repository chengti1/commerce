						...
						<div class="row">
							...
							<div class="col-sm-3 hidden-xs">
								...
								@else
									...
									<a id = "loggedinname" href="{{ Request::root() }}/login">Login</a>	&nbsp;	&nbsp;	&nbsp;		 <a href="{{ Request::root() }}/register">Create an account  	</a>
...
<p style="padding-top: 10px; margin-bottom: 0px">Stowear is beautyfull OpenCart theme with a lots of features. Build with HTML 5 & CSS 3.</p>						</div>
