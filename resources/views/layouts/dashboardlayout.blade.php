            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <h2>Menu</h2>
                  <li><a href = "{{ Request::root() }}/buyerdashboard"><i class="fa fa-home"></i> Member Area </a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> My Account <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ Request::root() }}/buyerdashboard/changepmethod">Payment Method</a></li>
                      <li><a href="#">Transaction Reports</a></li>
                      <li><a href="{{ Request::root() }}/buyerdashboard/updateprofile">Update Profile</a></li>
                      <li><a href="#">Buy Leads</a></li>
                      <li><a href="#">Sell Leads</a></li>
                      <li><a href="#">Swap Leads</a></li>
                    </ul>
                  </li>
                  <li><a href="{{ Request::root() }}/buyerdashboard/changesellerpassword"><i class="fa fa-desktop"></i> Change Password </a>
                  </li>
                  <li><a href = "{{ Request::root() }}/buyerdashboard/sellitem"><i class="fa fa-table"></i> Sell an Item </a>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Hunt an Item <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i> My Store <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
    ...
    <script>
      ...
      $(document).ready(function(){
        $('#category').change(function(){
          ...
          $.ajax({
            url: '{{Request::root()}}/buyerdashboard/getsubcategory?category_id='+category,
            type: 'get',
