...
<!-- end div captcha -->
	  ...
	  <!-- <input type="text" name="captcha" placeholder="Please input Captcha" required > -->
        ...
        @endif
    <div class="pull-right">I have read and agree to the <a href="index11ee.html?route=information/information/agree&amp;information_id=3" class="agree"><b>Privacy Policy</b></a>            <input type="checkbox" name="agree" value="1" required/>
