                                    ...
                                    <div itemscope itemtype="http://data-vocabulary.org/Product">
                                        ...
                                        <div class="product-info">
                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="product-image cloud-zoom" style = "height:465px; width:308px;">
                                                                        ...
                                                                        <img style = "height:465px; width:308px;" src="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image}}" title="{{$products->product_name}}" alt="{{$products->product_name}}" id="image" itemprop="image" data-zoom-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image}}">
                                                                    </div>

                                                                    <div class="col-sm-12">
                                                                        <div class="thumbnails thumbnails-left clearfix">
                                                                            <ul>
                                                                                <li><p><a href="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image}}" data-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image}}" data-zoom-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image}}"><img style = "height:67px; width:45px;" src="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image}}" title="{{$products->product_name}}" alt="{{$products->product_name}}"></a></p></li>
                                                                                @if($products->product_image_1 != '')
                                                                                <li><p><a href="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_1}}" data-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_1}}" data-zoom-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_1}}"><img style = "height:67px; width:45px;" src="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_1}}" title="{{$products->product_name}}" alt="{{$products->product_name}}"></a></p></li>
                                                                                @endif

                                                                                @if($products->product_image_2 != '')
                                                                                <li><p><a href="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_2}}" data-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_2}}" data-zoom-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_2}}"><img style = "height:67px; width:45px;" src="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_2}}" title="{{$products->product_name}}" alt="{{$products->product_name}}"></a></p></li>
                                                                                @endif

                                                                                @if($products->product_image_3 != '')
                                                                                <li><p><a href="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_3}}" data-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_3}}" data-zoom-image="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_3}}"><img style = "height:67px; width:45px;" src="{{URL::asset('/')}}images/hunt_seller/{{$products->product_image_3}}" title="{{$products->product_name}}" alt="{{$products->product_name}}"></a></p></li>
                                                                                @endif
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <td>Confirmed</td>
                                            @else
                                                <td><button class = "btn btn-success" onClick = "location.href = '{{Request::root()}}/buyerdashboard/confirm-hunt-buyer/{{$products->product_id}}'">Confirm</button></td>
                                            @endif
                                                                        </a>
                                                                                                                                            </div>
