                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <!--prahsant changed inline width-->
                                                                        ...
                                                                        <img
                                                                                    ...
                                                                                    data-zoom-image="{{URL::asset('/')}}images/product_master/{{$product->product_images}}"/>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <div class="thumbnails thumbnails-left clearfix">
                                                                            ...
                                                                            <ul>
                                                                                ...
                                                                                <li><p><a href="{{URL::asset('/')}}images/product_master/{{$product->product_images}}" data-image="{{URL::asset('/')}}images/product_master/{{$product->product_images}}" data-zoom-image="{{URL::asset('/')}}images/product_master/{{$product->product_images}}"><img style = " width:45px;" src="{{URL::asset('/')}}images/product_master/{{$product->product_images}}" title="{{$product->product_name}}" alt="{{$product->product_name}}"></a></p></li>



                                                                                @if($product->product_image_1 != '')

                                                                                <li><p><a href="{{URL::asset('/')}}images/product_master/{{$product->product_image_1}}" data-image="{{URL::asset('/')}}images/product_master/{{$product->product_image_1}}" data-zoom-image="{{URL::asset('/')}}images/product_master/{{$product->product_image_1}}"><img style = " width:45px;" src="{{URL::asset('/')}}images/product_master/{{$product->product_image_1}}" title="{{$product->product_name}}" alt="{{$product->product_name}}"></a></p></li>
                                                                                ...
                                                                                <li><p><a href="{{URL::asset('/')}}images/product_master/{{$product->product_image_2}}" data-image="{{URL::asset('/')}}images/product_master/{{$product->product_image_2}}" data-zoom-image="{{URL::asset('/')}}images/product_master/{{$product->product_image_2}}"><img style = " width:45px;" src="{{URL::asset('/')}}images/product_master/{{$product->product_image_2}}" title="{{$product->product_name}}" alt="{{$product->product_name}}"></a></p></li>
                                                                                ...
                                                                                <li><p><a href="{{URL::asset('/')}}images/product_master/{{$product->product_image_3}}" data-image="{{URL::asset('/')}}images/product_master/{{$product->product_image_3}}" data-zoom-image="{{URL::asset('/')}}images/product_master/{{$product->product_image_3}}"><img style = " width:45px;" src="{{URL::asset('/')}}images/product_master/{{$product->product_image_3}}" title="{{$product->product_name}}" alt="{{$product->product_name}}"></a></p></li>
                                                            ...
                                                            <div itemprop="offerDetails" itemscope
                                                                ...
                                                                <div class="price">
                                                                    ...
                                                                    <span class="price-new"><span
                                                                                ...
                                                                                itemprop="price">${{$product->price_after_discount}}</span></span>
...
<!-- <form method="post" enctype="multipart/form-data" action="form-review"> -->
    ...
    <!-- hidden fields for get product_id and user_id -->
        <input type="hidden" name="hidden_user_id" id="hidden_user_id" value="{{$userData['user_id']}}">
        <input type="hidden" name="hidden_product_id" id="hidden_product_id" value="{{$product->product_id}}">
    <!-- end hidden fields -->
            ...
            <b>Your Review</b>
            <textarea name="text" cols="40" rows="8" style="width: 100%;" id="textarea-name"></textarea>
        ...
        <div class="buttons">
            <div class="right">
                ...
                <a href="javascript:void(0);" id="button-review" class="button" onclick="review_conti()">Continue</a>
            </div>
        </div>
   ...
   <!--  product id:{{$list->product_id}} -->
        <div class="rating-filp" id="display_row">
            <div class="heading-top">
                <span class="hea">{{$list->rating}}<span class="star">★</span></span>
...
<style type="text/css">
    .display_review{height: auto;border-bottom: 1px solid #f0f0f0;}
    #display_row{padding: 0 20px; width: 100%; height: auto; display: inside-block;}
