			...
			<div class="pattern">
				...
				<div class="container">
					...
					<div class="clearfix">
						...
						<h1 id="title-page">Swap Items</h1>
						...
						<ul>
							...
							<li>
								...
								<a href="{{URL::current()}}">Swap Items</a>
						...
						<div class="col-sm-3" id="column_left">
							...
							<div class="box">
								...
								<div class="box-content" id="filter">
									...
									l><a class="button" id="button-filter">Refine Search</a>
									...
									<div class="product-filter clearfix">
										...
										<!-- <div class="options">
											...
											<div class="product-compare">
												...
												"http://themenis.com/opencart/stowear/v1/index.php?route=product/compare"

												id="compare-total">Product Compare (0)</a>

											</div>

											<div class="button-group display" data-toggle="buttons-radio">

												<button class="active" id="grid" onclick="display('grid');" rel=

												"tooltip" title="Grid"><i class="fa fa-th-large"></i></button>

												<button id="list" onclick="display('list');" rel="tooltip" title=
...
function display(view) {
	...
	<script type="text/javascript">
		$('#sort').change(function(){
			...
			window.location.href="{{request::root()}}/swap-listing?pagination="+pagination+"&sort="+sort+"&filter="+filter;
		})
