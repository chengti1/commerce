                                ...
                                <div class="col-sm-12 center-column">
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <form id="hunt-form" data-parsley-validate="" class="form-horizontal form-label-left" method = "post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <form action="{{Request::root()}}/login"
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        <button type="button"
                                                                                                ...
                                                                                                onClick="location.href='{{Request::root()}}/register'">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        $(document).ready(function(){
                                            ...
                                            $('form#hunt-form').submit(function(){
                                                ...
                                                $.ajax({
                                                    ...
                                                    url : '{{URL::asset('/')}}buyerdashboard/hunt-product-detail/{{$product->hunt_id}}',
